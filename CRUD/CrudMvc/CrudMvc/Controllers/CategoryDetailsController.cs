...
namespace CrudMvc.Controllers
{
    public class CategoryDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ColorValue")] CategoryDetail categoryDetail)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Categories, "Id", "Id", categoryDetail.Id);
            return View(categoryDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ColorValue")] CategoryDetail categoryDetail)
        {
