...
, item.IsActive, item.IsDeleted, item.Notes, item.
CurrentOrFinalPrice
, item.IsOnSale, item.PurchasedDate, item.PurchasePrice, item.
Quantity
, item.SoldDate, cat.[Name] Category, cat.IsActive
CategoryIsActive
, cat.IsDeleted CategoryIsDeleted, catDetail.ColorName,
catDetail.ColorValue
, player.[Name] PlayerName, player.[Description]
PlayerDescription
, player.IsActive PlayerIsActive, player.IsDeleted
PlayerIsDeleted
, genre.[Name] GenreName, genre.[IsActive] GenreIsActive,
